...
inside([[lightswitch175, bedroom74], [book192, bedroom74], [sofa369, livingroom336], [book192, bookshelf107]]).
ontopof([[pillow422, sofa369], [book192, bookshelf107], [pillow423, sofa369], [tv427, sofa369], [sofa369, rug418]]).
rooms(bedroom74).
rooms(livingroom336).
type(vacuum0, vacuum).
has_switch(vacuum0).
