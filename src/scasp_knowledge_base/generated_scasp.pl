...
readable(book192).
closed(book192, 0).
inside(book192, bedroom74, 0).
close(book192, character1, 0).
closed(book192, 1).
inside(book192, bedroom74, 1).
close(book192, character1, 1).
closed(book192, 2).
...
surfaces(chair109).
furniture(chair109).
inside(chair109, bedroom74, 0).
close(chair109, character1, 0).
inside(chair109, bedroom74, 1).
close(chair109, character1, 1).
inside(chair109, bedroom74, 2).
